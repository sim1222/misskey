...
<MkStickyContainer>
	...
	<MkSpacer :content-max="800">
		<div ref="rootEl" v-hotkey.global="keymap">
			<XTutorial v-if="$store.reactiveState.tutorial.value != -1" class="_panel blur" style="margin-bottom: var(--margin);"/>
			<XPostForm v-if="$store.reactiveState.showFixedPostForm.value" :class="$style.postForm" class="post-form _panel blur" fixed style="margin-bottom: var(--margin);"/>
