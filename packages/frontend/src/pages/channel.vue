...
<MkStickyContainer>
	...
	<MkSpacer :content-max="700" :class="$style.main">
		...
		<div v-if="channel && tab === 'timeline'" class="_gaps">
			...
			<MkPostForm v-if="$i && defaultStore.reactiveState.showFixedPostFormInChannel.value" :channel="channel" class="post-form _panel blur" fixed :autofocus="deviceKind === 'desktop'"/>
