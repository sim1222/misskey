...
export const locale = {
	...
	poweredByMisskeyDescription:
		"{name}は、オープンソースのプラットフォーム<b>Misskey</b>を使ったサービス(Misskeyインスタンスと呼ばれます)のひとつです。",
	...
	deleteAndEditConfirm:
		"このノートを削除してもう一度編集しますか？このノートへのリアクション、Renote、返信も全て削除されます。",
	addToList: "リストに追加",
	...
	driveFileDeleteConfirm:
		"ファイル「{name}」を削除しますか？このファイルを添付したノートも消えます。",
	...
	flagAsCatDescription:
		"このアカウントが猫であることを示す場合は、このフラグをオンにします。",
	...
	blockedInstancesDescription:
		"ブロックしたいインスタンスのホストを改行で区切って設定します。ブロックされたインスタンスは、このインスタンスとやり取りできなくなります。",
	...
	pinnedPagesDescription:
		"インスタンスのトップページにピン留めしたいページのパスを改行で区切って記述します。",
	...
	removeAllFollowingDescription:
		"{host}からのフォローをすべて解除します。そのインスタンスがもう存在しなくなった場合などに実行してください。",
	...
	forwardReportIsAnonymous:
		"リモートインスタンスからはあなたの情報は見れず、匿名のシステムアカウントとして表示されます。",
	send: "送信",
	...
	enableAutoSensitiveDescription:
		"利用可能な場合は、機械学習を利用して自動でメディアにNSFWフラグを設定します。この機能をオフにしても、インスタンスによっては自動で設定されることがあります。",
	...
	_ad: { back: "戻る", reduceFrequencyOfThisAd: "この広告の表示頻度を下げる" },
	_forgotPassword: {
		enterEmail:
	...
	_email: {
		_follow: { title: "フォローされました" },
		_receiveFollowRequest: { title: "フォローリクエストを受け取りました" },
	},
	_plugin: {
	...
	_wordMute: {
		...
		hardDescription:
			"指定した条件のノートをタイムラインに追加しないようにします。追加されなかったノートは、条件を変更しても除外されたままになります。",
		soft: "ソフト",
		hard: "ハード",
	...
	_instanceMute: {
		instanceMuteDescription:
			"ミュートしたインスタンスのユーザーへの返信を含めて、設定したインスタンスの全てのノートとRenoteをミュートします。",
	...
	_time: { second: "秒", minute: "分", hour: "時間", day: "日" },
	_tutorial: {
		title: "Misskeyの使い方",
		step1_1: "ようこそ。",
		step1_2:
			"この画面は「タイムライン」と呼ばれ、あなたや、あなたが「フォロー」する人の「ノート」が時系列で表示されます。",
		step1_3:
			"あなたはまだ何もノートを投稿しておらず、誰もフォローしていないので、タイムラインには何も表示されていないはずです。",
		step2_1:
			"ノートを作成したり誰かをフォローしたりする前に、まずあなたのプロフィールを完成させましょう。",
		step2_2:
			"あなたがどんな人かわかると、多くの人にノートを見てもらえたり、フォローしてもらいやすくなります。",
		step3_1: "プロフィール設定はうまくできましたか？",
		step3_2:
			"では試しに、何かノートを投稿してみてください。画面上にある鉛筆マークのボタンを押すとフォームが開きます。",
		step3_3: "内容を書いたら、フォーム右上のボタンを押すと投稿できます。",
		step3_4:
			"内容が思いつかない？「Misskey始めました」というのはいかがでしょう。",
		step4_1: "投稿できましたか？",
		step4_2: "あなたのノートがタイムラインに表示されていれば成功です。",
		step5_1:
			"次は、他の人をフォローしてタイムラインを賑やかにしたいところです。",
		step5_2:
			"{featured}で人気のノートが見れるので、その中から気になった人を選んでフォローしたり、{explore}で人気のユーザーを探すこともできます。",
		step5_3:
			"ユーザーをフォローするには、ユーザーのアイコンをクリックしてユーザーページを表示し、「フォロー」ボタンを押します。",
		step5_4:
			"ユーザーによっては、フォローが承認されるまで時間がかかる場合があります。",
		step6_1: "タイムラインに他のユーザーのノートが表示されていれば成功です。",
		step6_2:
			"他の人のノートには、「リアクション」を付けることができ、簡単にあなたの反応を伝えられます。",
		step6_3:
			"リアクションを付けるには、ノートの「+」マークをクリックして、好きなリアクションを選択します。",
		step7_1:
			"これで、Misskeyの基本的な使い方の説明は終わりました。お疲れ様でした。",
		...
		step8_4:
			"その場合は設定よりブラーを使用しないように設定＋テーマをNoGlassにしてください。",
	},
	_2fa: {
		...
		securityKeyInfo:
			"FIDO2をサポートするハードウェアセキュリティキーもしくは端末の指紋認証やPINを使用してログインするように設定できます。",
	},
	_permissions: {
	...
	_pages: {
		...
		blocks: {
			...
			textInput: "テキスト入力",
			_textInput: { name: "変数名", text: "タイトル", default: "デフォルト値" },
			...
			canvas: "キャンバス",
			_canvas: { id: "キャンバスID", width: "幅", height: "高さ" },
			note: "ノート埋め込み",
			_note: {
				id: "ノートID",
			...
			switch: "スイッチ",
			_switch: { name: "変数名", text: "タイトル", default: "デフォルト値" },
			counter: "カウンター",
			_counter: { name: "変数名", text: "タイトル", inc: "増加値" },
			_button: {
				text: "タイトル",
				colored: "色付き",
				action: "ボタンを押したときの動作",
				_action: {
					...
					_callAiScript: { functionName: "関数名" },
				},
			},
			radioButton: "選択肢",
			_radioButton: {
		...
		script: {
			...
			blocks: {
				...
				textList: "テキストのリスト",
				_textList: { info: "ひとつひとつを改行で区切ってください" },
				strLen: "テキストの長さ",
				_strLen: { arg1: "テキスト" },
				strPick: "文字取り出し",
				_strPick: { arg1: "テキスト", arg2: "文字の位置" },
				strReplace: "テキスト置き換え",
				_strReplace: {
					arg1: "テキスト",
					arg2: "置き換え前",
				...
				strReverse: "テキストを反転",
				_strReverse: { arg1: "テキスト" },
				join: "テキストを連結",
				_join: { arg1: "リスト", arg2: "区切り" },
				add: "足す",
				_add: { arg1: "A", arg2: "B" },
				subtract: "引く",
				...
				_gtEq: { arg1: "A", arg2: "B" },
				if: "分岐",
				_if: { arg1: "もし", arg2: "なら", arg3: "そうでなければ" },
				not: "否定",
				_not: { arg1: "否定" },
				random: "ランダム",
				_random: { arg1: "確率" },
				rannum: "乱数",
				_rannum: { arg1: "最小", arg2: "最大" },
				randomPick: "リストからランダムに選択",
				_randomPick: { arg1: "リスト" },
				dailyRandom: "ランダム (ユーザーごとに日替わり)",
				_dailyRandom: { arg1: "確率" },
				dailyRannum: "乱数 (ユーザーごとに日替わり)",
				_dailyRannum: { arg1: "最小", arg2: "最大" },
				dailyRandomPick: "リストからランダムに選択 (ユーザーごとに日替わり)",
				_dailyRandomPick: { arg1: "リスト" },
				seedRandom: "ランダム (シード)",
				_seedRandom: { arg1: "シード", arg2: "確率" },
				seedRannum: "乱数 (シード)",
				_seedRannum: { arg1: "シード", arg2: "最小", arg3: "最大" },
				seedRandomPick: "リストからランダムに選択 (シード)",
				_seedRandomPick: { arg1: "シード", arg2: "リスト" },
				DRPWPM: "確率付きリストからランダムに選択 (ユーザーごとに日替わり)",
				_DRPWPM: { arg1: "テキストのリスト" },
				pick: "リストから選択",
				_pick: { arg1: "リスト", arg2: "位置" },
				listLen: "リストの長さを取得",
				_listLen: { arg1: "リスト" },
				number: "数値",
				stringToNumber: "テキストを数値に",
				_stringToNumber: { arg1: "テキスト" },
				numberToString: "数値をテキストに",
				_numberToString: { arg1: "数値" },
				splitStrByLine: "テキストを行で分割",
				_splitStrByLine: { arg1: "テキスト" },
				ref: "変数",
				...
				for: "繰り返し",
				_for: { arg1: "回数", arg2: "処理" },
			},
			typeError:
				'スロット{slot}は"{expect}"を受け付けますが、"{actual}"が入れられています！',
	...
	_notification: {
		...
		_actions: { followBack: "フォローバック", reply: "返信", renote: "Renote" },
	},
	_deck: {
