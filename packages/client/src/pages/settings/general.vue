...
<div class="_formRoot">
	...
	<FormSection>
		...
		<FormSelect v-model="serverDisconnectedBehavior" class="_formBlock">
			...
			<option value="indicate">{{ i18n.ts._serverDisconnectedBehavior.indicate }}</option>
		</FormSelect>
	</FormSection>
	...
	<FormSelect v-model="defaultNavigationBehaviour">
		...
		<option value="page">{{ i18n.ts.showInPage }}</option>
		<option value="sideView">{{ i18n.ts.openInSideView }}</option>
